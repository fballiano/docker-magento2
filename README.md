...
php bin/magento setup:install \
  ...
  --backend-frontname admin --admin-firstname AdminFirstName --admin-lastname AdminLastName --admin-email 'admin@email.com' --admin-password 'ChangeThisPassword' --base-url 'https://magento2.docker/' --language en_US \
